...
- [Reporting](stages/report.md) (for bug bounty) - Documenting the findings with Proof Of Concept (POC) and remediation steps
...
- SQL Injection
- [Path Traversal](vulnerabilities/path_traversal.md)
- Cross-Site Request Forgery (CSRF)
- [Server-Side Request Forgery (SSRF)](vulnerabilities/ssrf.md)
- Command Injection
- JWT 
- [File Upload Vulnerability](vulnerabilities/file_upload.md)
